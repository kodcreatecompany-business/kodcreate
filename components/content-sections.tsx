...
export function ServiceSection() {
  return <section id="service" className="section-padding page-container" aria-labelledby="service-title">
    ...
    <div className="section-heading-row">
      <h2 id="service-title">One service.<br /><span className="highlight-text">Every detail.</span></h2>
      ...
      <Reveal>
        <div className="about-layout">
          ...
          <div className="about-copy">
            ...
            <h2>A small studio.<br /><span className="highlight-text">A personal approach.</span></h2>
            ...
            <p>Every line of code and design decision is crafted with intention to elevate your brand. You get direct access, fast turnarounds, and a bespoke digital presence engineered to convert visitors into loyal clients.</p>
